A student result system has a parent class that checks marks and a child class that finalizes the result. The system should ensure that marks are between 0 and 100. If invalid marks are provided, the program should handle it properly.
